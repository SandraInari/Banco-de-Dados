...
UPDATE PACIENTES SET EMAIL = 'mel.lisboa@gmail.com' WHERE CODIGO = 5
...
SELECT * FROM CONSULTAS WHERE [DATA] >= '20130401' AND '20130430'
ROLLBACK
COMMIT
...
SELECT VALOR, HORA FROM CONSULTAS WHERE HORA = '10:00:00'
UPDATE CONSULTAS SET VALOR = VALOR * 0.8 WHERE HORA = '10:00:00'
